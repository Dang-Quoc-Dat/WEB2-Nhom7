    ...
    <body>
        ...
        <div class="container" >
            <form class="form"  action="xuathang?action=saveTrangThai" method="POST">
                <div class="title">Cập nhật trạng thái</div>
                <%
                ...
                <div class="input-container ic1">
                    ...
                    <input id="MaHang" class="input" type="text" placeholder="Mã Hàng" name="txtMaHang" value="<%=xh.getMaHang()%>" readonly />
                    <div class="cut"></div> 
                </div>
                ...
                <input type="submit" class="submit" value="Cập nhật">
