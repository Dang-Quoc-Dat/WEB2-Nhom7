<%-- 
    Document   : danhsachxuathang
    Created on : Nov 18, 2021, 10:31:11 AM
    Author     : Dell
--%>
    ...
    <body>
        ...
        <div id="mid">
            ...
            <div id="sidebar_right">
                ...
                <%
                    if (request.getAttribute("searchXuatHang") != null) {
                        List<XuatHang> a = (List<XuatHang>) request.getAttribute("searchXuatHang"); // ép kiểu 
                        if (a != null) {
                %>
