<%-- 
    Document   : timkiemxuatngay
    Created on : Nov 18, 2021, 11:15:30 AM
    Author     : Dell
--%>
    ...
    <body>
        ...
        <div id="mid">
            ...
            <div id="sidebar_right">
                ...
                <%
                    if (request.getAttribute("searchXuatHangTrangThai") != null) {
                        List<XuatHang> a = (List<XuatHang>) request.getAttribute("searchXuatHangTrangThai"); // ép kiểu 
                        if (a != null) {
                %>
